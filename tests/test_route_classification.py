...
_HUMAN: dict[tuple[str, str], Permission] = {
    ...
    # The read-only events/counts surfaces (blizzard#255 D2) — the events they derive
    # from are exactly what TRANSCRIPT_READ already opens, so reads take that grant
