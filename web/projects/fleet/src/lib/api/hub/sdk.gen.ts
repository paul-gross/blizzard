 ...
 */
export const listProposalsApiProposalsGet = <ThrowOnError extends boolean = false>(options?: Options<ListProposalsApiProposalsGetData, ThrowOnError>): RequestResult<ListProposalsApiProposalsGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ListProposalsApiProposalsGetResponses, unknown, ThrowOnError>({ url: '/api/proposals', ...options });
 ...
 */
export const getProposalApiProposalsProposalIdGet = <ThrowOnError extends boolean = false>(options: Options<GetProposalApiProposalsProposalIdGetData, ThrowOnError>): RequestResult<GetProposalApiProposalsProposalIdGetResponses, GetProposalApiProposalsProposalIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetProposalApiProposalsProposalIdGetResponses, GetProposalApiProposalsProposalIdGetErrors, ThrowOnError>({ url: '/api/proposals/{proposal_id}', ...options });
