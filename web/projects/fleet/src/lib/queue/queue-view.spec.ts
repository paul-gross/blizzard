...
const ENTRIES = [
  { chunk_id: 'ch_top', graph_id: 'gr_1', position: 0, work_refs: [{ source: 'widget', ref: '1' }] },
  { chunk_id: 'ch_mid', graph_id: 'gr_1', position: 1, work_refs: [{ source: 'widget', ref: '2' }] },
  { chunk_id: 'ch_low', graph_id: 'gr_1', position: 2, work_refs: [] },
];
