...
/**
 * The graph detail's **lifecycle** section — the `canEdit`-gated retire/re-enable
 * controls (issue #101, gated on `graph:edit` — issue #93), the action-error line
 ...
 * (the identity supplement — badge and graph id) lives instead.
 *
 ...
 * pattern for pause/detach — but the mutation itself stays in `GraphDetail`
