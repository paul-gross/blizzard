...
Assess the build you just completed against this node's criteria: the change implements the PM item's intent, with your work committed, pushed, and declared (`blizzard runner artifact commit` for each repo you touched).
