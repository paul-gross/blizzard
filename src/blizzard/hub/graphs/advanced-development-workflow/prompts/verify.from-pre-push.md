...
The branches have been rewritten since you last saw them. The change re-earns its verification as it now stands:
exercise it through the project's declared methods, with particular attention to the behavior the resolutions touched.
