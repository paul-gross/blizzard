...
Render your review verdict. Your findings ride forward as the `review-findings` asset — if you have not yet run `blizzard runner artifact create --name review-findings` with your findings on stdin, do that now before you record this verdict. State what you reviewed per axis and every blocking issue you found.
