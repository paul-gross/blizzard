...
Render your gate verdict. Your findings ride forward as the `plan-findings` asset — if you have not yet run `blizzard runner artifact create --name plan-findings` with your findings on stdin, do that now before you record this verdict.
