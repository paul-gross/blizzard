...
here. Run the node's checks (`mise run lint`, `mise run test`) and satisfy the PM
item's intent before you declare done — treat the checks as this node's own finale,
not a formality deferred to a later step.
