...
Your commits are intact on the feature branch; nothing has landed. Check each finding against the code as it now stands
...
record, a finding you deliberately declined is re-discovered and re-raised every round.
