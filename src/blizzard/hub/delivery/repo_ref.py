...
naming who owns it yields ``None`` rather than a guess (:meth:`RepoRef.parse`). Pure and
...
class RepoRef:
    ...
    @classmethod
    def parse(cls, origin_url: str) -> RepoRef | None:
        ...
        return cls(host=host, owner=segments[-2], name=segments[-1])
