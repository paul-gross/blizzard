...
class DecisionService:
    ...
    def resolve(
        ...
        in the same write (D2, blizzard#367). ``None`` if no such decision. A struck id
        naming anything but one of the decision's chunk's own pending, unstruck
        proposals raises — the same rejection class as an invalid ``choice`` (D4)."""
