"""close_intent_attempts — one row per close-intent drain attempt, appended with its
outcome (blizzard#524 D7). One new table, no backfill: an empty table starts every
pending intent immediately due.
