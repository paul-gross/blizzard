...
#   ruff format --check · ruff check · pyright · structural gate (ast-grep) · pytest
#   (unit + component) · OpenAPI spec drift · eslint · vitest · structural gate
#   (real-timer) · generated-client drift
#
